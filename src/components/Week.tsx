...
const Week: React.FC = () => {
  return (
    <div className="weather__week week">
      <h2 className="week__title title">Week</h2>
      <div className="week-items">
        <div className="week__item">
          <h3 className="week__item-day">Tuesday</h3>
          <img className="week__item-img" src="/images/icons/cloud_wind.svg" alt="wind" />
          <p className="week__item-desc">Windy</p>
        ...
        <div className="week__item">
          <h3 className="week__item-day">Wednesday</h3>
          <img className="week__item-img" src="/images/icons/cloud_rain.svg" alt="rain" />
          <p className="week__item-desc">Rainy</p>
          <div className="week__item-temp">
            <div className="week__item-max">
              <svg viewBox="0 0 32 32" xmlSpace="preserve">
                <title />
        ...
        <div className="week__item">
          <h3 className="week__item-day">Thursday</h3>
          <img className="week__item-img" src="/images/icons/cloud_thunder.svg" alt="thunder" />
          <p className="week__item-desc">Thunder</p>
          <div className="week__item-temp">
            <div className="week__item-max">
              <svg viewBox="0 0 32 32" xmlSpace="preserve">
                <title />
        ...
        <div className="week__item">
          <h3 className="week__item-day">Friday</h3>
          <img className="week__item-img" src="/images/icons/cloud_sun.svg" alt="sun" />
          <p className="week__item-desc">Sunny</p>
          <div className="week__item-temp">
            <div className="week__item-max">
              <svg viewBox="0 0 32 32" xmlSpace="preserve">
                <title />
        ...
        <div className="week__item">
          <h3 className="week__item-day">Saturday</h3>
          <img className="week__item-img" src="/images/icons/cloud_sun.svg" alt="sun" />
          <p className="week__item-desc">Sunny</p>
          <div className="week__item-temp">
            <div className="week__item-max">
        ...
        <div className="week__item">
          <h3 className="week__item-day">Sunday</h3>
          <img className="week__item-img" src="/images/icons/cloud.svg" alt="cloud" />
          <p className="week__item-desc">Cloudy</p>
          <div className="week__item-temp">
            <div className="week__item-max">
              <svg viewBox="0 0 32 32" xmlSpace="preserve">
                <title />
