...
import { getWeatherSunrice } from '../utils/getWeatherSunrice';
import { getWeatherSunset } from '../utils/getWeatherSunset';
  ...
  return (
    <div className="information__col information__col-sun sun">
      ...
      <div className="information__col-sunrise">
        ...
        <time>{weatherToday && getWeatherSunrice(weatherToday)}</time>
      </div>
      <div className="information__col-sunset">
        ...
        <time>{weatherToday && getWeatherSunset(weatherToday)}</time>
      </div>
    </div>
  );
};
