...
const Week = () => {
  ...
  return (
    <section className={isAnimate ? 'week animate' : 'week'}>
      <div className="week__title title">Week</div>
      <div className="week__days">
        <div className="week__day">
          <h3 className="week__day-day">Monday</h3>
          <img className="week__day-img" src={`/images/icons/cloud.svg`} alt="wind" />
          <p className="week__day-desc">Clouds</p>
          <div className="week__day-temp">
            <div className="week__day-max">
